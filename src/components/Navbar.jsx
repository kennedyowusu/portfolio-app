 ...
 const handleIsMenuOpenClick = () => {
  ...
  return (
    ...
    <div className="container mx-auto flex justify-between items-center w-5/6">
     <h4 className="font-playfair text-3xl font-bold">Kennedy</h4>
       ...
       <div className="flex justify-between gap-16 font-opensans text-sm font-semibold">
        {
         navNames.map((page, index) => (
          <NavLinks key={index} page={page} selectedPage={selectedPage} setSelectedPage={setSelectedPage} />
         ))
        }
          </div>
        ) : (
     ...
     {/* MOBILE MENU POPUP */}
     {
      !isAboveSmallScreen && isMenuOpen && (
       <div className="fixed flex flex-col right-0 bottom-0 h-full bg-blue w-[300px] gap-10 text-2xl
       ">
